...
var skully = document.querySelector('.skully');
const chickenDinner = document.querySelector('.chicken-dinner');

var froggy = new Froggy(frog, 300, 400, 50, 50, 50);
var car = new Car(truck, 580, 250, 100, 50, -2);
var loggy = new Loggy(log, 0, 100, 100, 50, 2);
var loggy2 = new Loggy(log, 300, 150, 100, 50, -2);
var loggy3 = new Loggy(log, 500, 50, 100, 50, -2);
...
function gameScore() {
	...
	if(froggy.score > 2) {
		context.drawImage(chickenDinner, 200, 100, 200, 300);
		playAgain();
	}
}